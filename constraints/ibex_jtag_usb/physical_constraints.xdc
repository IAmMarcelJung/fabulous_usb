...
# set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports {trst_o}]
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports {configured}]
...
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports {captured_tdo}]
